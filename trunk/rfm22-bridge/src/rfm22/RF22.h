...
#define RF22_h
#include <stdint.h>
#include "../dispatcher/DispatcherModule.h"
...
public:
    ...
    RF22(uint8_t slaveSelectPin = 0, uint8_t interrupt = 0);
    ...
    void setDispatcherModule(DispatcherModule *dispatcherModule);
