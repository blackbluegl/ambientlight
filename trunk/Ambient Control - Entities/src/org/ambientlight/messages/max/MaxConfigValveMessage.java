...
public class MaxConfigValveMessage extends MaxMessage {
	...
	public static final int DEFAULT_MAX_VALVE_POSITION = 255;
	public static final int MAX_VALVE_POSITION = 255;
	...
	public MaxConfigValveMessage() {
		...
		this.setValveOffset(DEFAULT_VALVE_OFFSET);
		this.setMaxValvePosition(DEFAULT_MAX_VALVE_POSITION);
	}
	...
	public void setMaxValvePosition(int position) {
		if (position > MAX_VALVE_POSITION) {
			position = MAX_VALVE_POSITION;
		}
