package org.ambientlight.rendering.effects.transitions;
...
public class SimpleFadeInTransitionImpl implements FadeInTransition {
	...
	/* (non-Javadoc)
	 * @see org.ambientlight.scenery.rendering.effects.RenderingEffects#afterRendering(java.awt.image.BufferedImage)
	 */
	@Override
