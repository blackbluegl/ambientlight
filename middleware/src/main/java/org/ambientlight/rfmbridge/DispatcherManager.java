...
public class DispatcherManager {
	...
	public void startDispatchers() {
		...
		for (final Dispatcher currentDispatcher : outDispatchers.values()) {
			...
			if (currentDispatcher instanceof InDispatcher) {
				InDispatcher currentInDispatcher = (InDispatcher) currentDispatcher;
				startReceiveMessages(currentInDispatcher);
				startHeartBeatCheck(currentInDispatcher);
			}
	...
	private void startHeartBeatCheck(final InDispatcher dispatcher) {
	...
	public synchronized boolean dispatchMessage(Message message) {
		...
		return dispatcher.deliverOutMessage(message);
	}
